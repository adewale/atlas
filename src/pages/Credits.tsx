...
export default function Credits() {
  ...
  const structuredText = `${credits.structured.provider} — ${credits.structured.license}. Atomic mass, electronegativity, ionisation energy, radius, density, melting/boiling point, half-life, and phase data.`;
