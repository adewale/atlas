...
const ENRICHMENT: Record<string, EnrichmentRecord> = {
  ...
  Cr:  { discoveryYear: 1797, discoverer: 'Louis Nicolas Vauquelin', etymologyOrigin: 'property', etymologyDescription: 'Greek chroma: colour, from its vivid compounds' },
  ...
  Zr:  { discoveryYear: 1789, discoverer: 'Martin Heinrich Klaproth', etymologyOrigin: 'mineral', etymologyDescription: 'Arabic zargun: gold-coloured, from zircon mineral' },
  ...
  In:  { discoveryYear: 1863, discoverer: 'Ferdinand Reich & Hieronymus Richter', etymologyOrigin: 'property', etymologyDescription: 'Latin indicum: indigo, from its spectral line colour' },
  ...
  I:   { discoveryYear: 1811, discoverer: 'Bernard Courtois', etymologyOrigin: 'property', etymologyDescription: 'Greek ioeides: violet, from its vapour colour' },
  ...
  Ir:  { discoveryYear: 1803, discoverer: 'Smithson Tennant', etymologyOrigin: 'mythology', etymologyDescription: 'Greek Iris: goddess of the rainbow, from its colourful salts' },
