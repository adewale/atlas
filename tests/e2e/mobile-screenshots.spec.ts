...
const routes: { path: string; label: string }[] = [
  { path: '/', label: 'home' },
  { path: '/elements/Fe', label: 'element-fe' },
  { path: '/elements/H', label: 'element-h' },
  { path: '/elements/Og', label: 'element-og' },
  { path: '/groups/8', label: 'atlas-group-8' },
  { path: '/periods/4', label: 'atlas-period-4' },
  { path: '/blocks/d', label: 'atlas-block-d' },
  { path: '/categories/transition-metal', label: 'atlas-category-transition-metal' },
  { path: '/properties/mass', label: 'atlas-rank-mass' },
  { path: '/anomalies/synthetic-heavy', label: 'atlas-anomaly-synthetic-heavy' },
  { path: '/elements/Fe/compare/Cu', label: 'compare-fe-cu' },
  { path: '/about', label: 'about' },
  { path: '/about/credits', label: 'credits' },
  { path: '/about/design', label: 'design' },
  { path: '/about/entity-map', label: 'entity-map' },
